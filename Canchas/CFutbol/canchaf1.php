        ...
        <div class="row">
            <div class="col-lg-12">
               <h1 class="page-header"><?php echo $nombres[0]?>
                    <small><?php echo $nombreC[0]?></small>
                </h1>
            </div>
        </div>
        <!-- /.row -->
  ...
  function showDivs(n) {
    ...
    for (i = 0; i < x.length; i++) {
      ...
      x[slideIndex-1].style.display = "block";  
            ...
            <div class="col-md-4">
                <h3><?php echo $nombreC[0]?></h3>
                <h4> Precio :<?php echo $precio[0]?></h4> 
                          ...
                          <!--<a href="#" class="btn btn-primary btn-xs pull-right"><b>+</b> Add new categories</a> -->
                              <tr>
                                  ...
                                  <?php
                                    ...
                                    $query1 = "SELECT * FROM horarios WHERE id_cancha= '0' AND id_cliente IS NULL";
